                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <Link state={{ item }} to={`/dashboard/register/${item.id}`}>
                                                    <button
                                                        type="button"
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <Link state={{ item }} to={`/dashboard/report/${item.id}/delete`}>
                                                    <button class="block text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle={`popup-modal-${item.id}`}>
                                                        Delete
                                                    </button>
                                                </Link>
                                                <div id={`popup-modal-${item.id}`} tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full justify-center items-center" aria-hidden="true">
